...
window.COURSE_CURRICULUM = [
  ...
  },
  {
    ...
    submodules: [
      { n: "5.1", secs: 217, title: "Welcome & What This Module Unlocks", lessons: ["Welcome & What This Module Unlocks"] },
      { n: "5.2", secs: 1460, title: "Why Prompt Engineering Exists — Same Model, Different Results", lessons: ["Why Prompt Engineering Exists — Same Model, Different Results"] },
      { n: "5.3", secs: 906, title: "The 5-Part Prompt Skeleton — Overview & Why It Works", lessons: ["The 5-Part Prompt Skeleton — Overview & Why It Works"] },
      { n: "5.4", secs: 2046, title: "Part 1 — Role & Conversation History", lessons: ["Part 1 — Role & Conversation History"] },
      { n: "5.5", secs: 773, title: "Roles in Production — Personas & Guardrails", lessons: ["Roles in Production — Personas & Guardrails"] },
      { n: "5.6", secs: 979, title: "Part 2 — Instruction: Saying Exactly What to Do", lessons: ["Part 2 — Instruction: Saying Exactly What to Do"] },
      { n: "5.7", secs: 901, title: "Part 2A — Instruction in Code", lessons: ["Part 2A — Instruction in Code"] },
      { n: "5.8", secs: 1723, title: "Part 3 — Context & Input: Delimiting the Data", lessons: ["Part 3 — Context & Input: Delimiting the Data"] },
      { n: "5.9", secs: 2123, title: "Part 4 — Output Format: Structured Output", lessons: ["Part 4 — Output Format: Structured Output"] },
      { n: "5.10", secs: 957, title: "Prompt Templates & LCEL — Concepts", lessons: ["Prompt Templates & LCEL — Concepts"] },
      { n: "5.11", secs: 1834, title: "Prompt Templates & LCEL — Python Implementation", lessons: ["Prompt Templates & LCEL — Python Implementation"] },
      { n: "5.12", secs: 1073, title: "Chatbot History — Concepts", lessons: ["Chatbot History — Concepts"] },
      { n: "5.13", secs: 1487, title: "Chatbot History — Python Implementation", lessons: ["Chatbot History — Python Implementation"] },
      { n: "5.14", secs: 887, title: "Zero-Shot vs Few-Shot — Showing Beats Telling", lessons: ["Zero-Shot vs Few-Shot — Showing Beats Telling"] },
      { n: "5.15", secs: 980, title: "Zero-Shot vs Few-Shot — Python Implementation", lessons: ["Zero-Shot vs Few-Shot — Python Implementation"] },
      { n: "5.16", secs: 1428, title: "Chain-of-Thought & Reasoning Prompting — Concepts", lessons: ["Chain-of-Thought & Reasoning Prompting — Concepts"] },
      { n: "5.17", secs: 1051, title: "Chain-of-Thought & Reasoning Prompting — Python", lessons: ["Chain-of-Thought & Reasoning Prompting — Python"] },
      { n: "5.18", secs: 1192, title: "Structured Output — JSON Schema, TypedDict & Pydantic", lessons: ["Structured Output — JSON Schema, TypedDict & Pydantic"] },
      { n: "5.19", secs: 921, title: "Structured Output with TypedDict", lessons: ["Structured Output with TypedDict"] },
      { n: "5.20", secs: 703, title: "Structured Output with Pydantic", lessons: ["Structured Output with Pydantic"] },
      { n: "5.21", secs: 1076, title: "Images & Screenshots — Multimodal Inputs", lessons: ["Images & Screenshots — Multimodal Inputs"] },
      { n: "5.22", secs: 1007, title: "Images & Screenshots — Python Implementation", lessons: ["Images & Screenshots — Python Implementation"] },
      { n: "5.23", secs: 1846, title: "Applied Prompt Patterns — Customer Support Workflow Part 1", lessons: ["Applied Prompt Patterns — Customer Support Workflow Part 1"] },
      { n: "5.24", secs: 5129, title: "Capstone Project — Production Prompt Engineering Chatbot Control Panel", lessons: ["Capstone Project — Production Prompt Engineering Chatbot Control Panel"] }
    ]
  },
  {
    n: "06",
...
window.COURSE_INFO = {
  ...
  // Live countdown for the offer badge (falls back to priceOfferLabel if unset).
  offerStartISO: "2026-08-25",
  offerDays: 45,
...
window.COURSE_FAQ = [
  ...
  { q: "How much does the course cost?", a: "The course is ₹29,999 as a launch offer for the first 45 days (regular price ₹34,999), and 18% GST is already included. We've deliberately kept it affordable compared to market alternatives, because I want serious students to be able to join, not just those with deep pockets. It covers everything — all modules, quizzes, assignments, capstones, doubt support within 24 hours, weekly live sessions, mock interviews, resume prep, and biweekly updates. And if you want to start today without spending anything, the free 26-week roadmap on this site is always open." },
